...
/**
* @brief Class that represents a state for obtaining the number of stops with a upper limit as user input.
*/
...
public:
    ...
    /**
    * @brief Constructs an instance of GetTopState with specified back state and callback function.
    *
    * @details This constructor initializes an instance of the GetTopState class with the given back state and
    ...
    */
    ...
    /**
    * @brief Displays a prompt for inserting the number of top elements.
    *
    * @details This method prints a prompt to the console, asking the user to insert the number of top elements.
    * The displayed prompt guides the user on the expected format for entering the number of top elements. The user is
    * expected to input a valid integer representing the desired number of top elements for a specific operation.
    */
    void display() const override;

    /**
    * @brief Handles user input for obtaining the number of top elements.
    *
    * @details This method reads a line of input from the console, representing the desired number of top elements for a specific operation.
    * The method validates the entered input, ensuring it is a valid positive integer not greater than 3019 (the maximum number of airports).
