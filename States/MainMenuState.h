...
/**
* @brief Class representing the main menu state of the flight management system.
*/
...
public:
    ...
    * method transitions to the appropriate state based on the user's choice (Statistics, Get Flight, Other Methods, or Exit).
